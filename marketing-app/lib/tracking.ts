...
export function processUnsubscribe(token: string): boolean {
  ...
  // Mark queue entries as unsubscribed
  ...
  // Update campaign unsubscribe_count for any campaign this contact was part of
  db.prepare(
